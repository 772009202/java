...
public class ListSLinked<E> implements List<E> {
  ...
  private SLNode getPreNode(Object obj) {
    ...
    while (null != p.getNext()) {
      ...
      if (next.getData() != null && next.getData().equals(obj)) return p == head ? null : p;
      p = next;
    }
  ...
  private SLNode getNode(Object obj) {
    ...
    while (null != p.getNext()) {
      SLNode next = p.getNext();
      if (next.getData() != null && next.getData().equals(obj)) return p;
      p = next;
    }
  ...
  public int indexOf(Object o) {
    ...
    while (null != p.getNext()) {
      index++;
      SLNode next = p.getNext();
      if (null != next.getData() && next.getData().equals(o)) return index;
      p = next;
    }
  ...
  public int lastIndexOf(Object o) {
    ...
    while (null != p.getNext()) {
      index++;
      SLNode next = p.getNext();
      if (null != next.getData() && next.getData().equals(o)) lastIndex = index;
      p = next;
    }
