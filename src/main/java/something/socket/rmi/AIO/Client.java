package something.socket.rmi.AIO;
...
/** Created by YuChen on 2017/12/19 0019 */
public class Client {
...
class ReadHandler2 implements CompletionHandler<Integer, ByteBuffer> {
...
class WriteHandler implements CompletionHandler<Integer, ByteBuffer> {
  ...
  public void completed(Integer result, ByteBuffer buffer) {
    ...
    if (buffer.hasRemaining()) {
      ...
      clientChannel.read(readBuffer, readBuffer, new ReadHandler2(clientChannel, latch));
    }
  }
